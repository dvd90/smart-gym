...
const client = require('../client')(3000, 'localhost');
...
`);
  ...
  describe('showMachines', function () {
    it(`should return the initial state:
      ...
      return client
        .sendData('showMachines')
        .should.eventually.include('1,AirSquatMachine,off')
        .and.include('2,LegPress,off,100');
    });
  });
